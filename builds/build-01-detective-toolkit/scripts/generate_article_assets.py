...
──────────────────────────
Run every Build 1 script once and produce reusable article assets:
...
BUILD_ROOT  = SCRIPTS_DIR.parent                # .../build-01-detective-toolkit/
...
MANIFEST: list[tuple[str, str]] = [
    ("part-01-transformers/01_tokens.py",               "CASE FILE 01 — Tokenization"),
    ("part-01-transformers/02_token_ids.py",             "CASE FILE 02 — Token IDs"),
    ("part-01-transformers/03_simple_tokenizer.py",      "CASE FILE 03 — The Tokenizer"),
    ("part-01-transformers/04_embeddings.py",            "CASE FILE 04 — Embeddings"),
    ("part-01-transformers/05_positional_encoding.py",   "CASE FILE 05 — Positional Encoding"),
    ("part-01-transformers/06_attention.py",             "CASE FILE 06 — Attention"),
    ("part-01-transformers/07_self_attention.py",        "CASE FILE 07 — Self-Attention"),
    ("part-01-transformers/08_multi_head_attention.py",  "CASE FILE 08 — Multi-Head Attention"),
    ("part-01-transformers/09_transformer_layer.py",     "CASE FILE 09 — The Transformer Layer"),
    ("part-02-llm-training/01_training_examples.py",     "CASE FILE 10 — Training Data"),
    ("part-02-llm-training/02_next_token_prediction.py", "CASE FILE 11 — Next Token Prediction"),
    ("part-02-llm-training/03_loss_function.py",         "CASE FILE 12 — The Loss Function"),
    ("part-02-llm-training/04_gradient_descent.py",      "CASE FILE 13 — Gradient Descent"),
    ("part-02-llm-training/05_training_loop.py",         "CASE FILE 14 — The Training Loop"),
]
...
<body>
  <div class="window">
    ...
    <div class="footer">
      <span class="footer-left">Build 1 — The First Detective Toolkit</span>
...
def run_script(script_path: Path) -> tuple[str, float, bool]:
    """Execute a Build 1 script and return (stdout, elapsed_s, success)."""
...
def write_summary(rows: list[dict], timestamp: str) -> None:
    ...
    lines += [
        ...
        "",
        "```bash",
        "# From builds/build-01-detective-toolkit/",
...
def main() -> None:
    print("=" * 62)
    print("  Article Asset Generator — Build 1")
    print("=" * 62)
